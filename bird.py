...
import sys, time, math, threading, struct, argparse
...
class Params:
    def __init__(self):
        ...
        # Síntesis
        self.fc, self.fm, self.beta, self.decay = 2500.0, 10.0, 80.0, 4.0
    ...
    while True:
        try:
            ...
            if item[0] == "BTN":
                ...
                with P.lock:
                    if cc==30: P.fc   = map_7bit(val7, 435.0, 2800.0)
                    ...
                    elif cc==35: P.decay= map_7bit(val7, 0.1, 7.0)
